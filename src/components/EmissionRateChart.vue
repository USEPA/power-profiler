<template>
    <div>
        <div id="nationalEmissionRate">
            ...
            <p>This chart compares the average emission rates in pounds per <a @click="$parent.$parent.showMegaWattInfo = true" href="javascript:void(0)">MWh</a> in all <a href="https://epa.gov/sites/production/files/2018-12/egrid2016_subregions_2.jpg" target="_blank">eGRID subregions</a> to the national average emission rates for <a href="/ghgemissions/overview-greenhouse-gases#carbon-dioxide" target="_blank">carbon dioxide (CO<sub>2</sub>)</a>, <a href="/so2-pollution" target="_blank">sulfur dioxide (SO<sub>2</sub>)</a>, and <a href="/no2-pollution" target="_blank">nitrogen oxide (NO<sub>X</sub>)</a>.</p>
