<template>
    <div>
        <p>This map provides <a href="https://www.epa.gov/sites/production/files/2018-12/egrid2016_subregions_2.jpg" target="_blank">eGRID subregion</a> renewable percentages.</p>
