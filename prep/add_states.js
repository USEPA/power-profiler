...
var fs = require('fs');
var egrid_file = fs.readFileSync('data/shape/eGRID2019_subregions.json');
...
fs.writeFile('data/shape/egrid_2019_subregions_states.json', JSON.stringify(states_j), 'utf-8', function(err){
