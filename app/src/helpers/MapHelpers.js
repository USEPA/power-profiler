...
function addSubregionLabels(svg, path, subregionData) {
  var whiteRect = svg
    ...
    .attr("class", function(d) {
      if (
        d.properties.name == "NYLI" ||
        d.properties.name == "NYCW" ||
        d.properties.name == "AKGD"
      ) {
        return "smSubregion";
      }
      return "whiteRect";
  ...
  whiteRect
    ...
    .attr("y", function(d) {
      if (d.properties.name == "AKGD") {
        ...
        d.properties.name == "CAMX" ||
        d.properties.name == "AZNM" ||
        d.properties.name == "RMPA" ||
        d.properties.name == "SPNO" ||
        d.properties.name == "SRVC" ||
        d.properties.name == "RFCW"
      ) {
